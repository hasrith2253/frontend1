...
export const navLinkClass = "text-sm sm:text-base text-[#6e6e73] hover:text-[#1d1d1f] transition-colors font-normal";
export const navLinkActiveClass = "text-sm sm:text-base text-[#0066cc] font-medium";
